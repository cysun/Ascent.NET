...
CREATE TABLE "MftDistributionTypes" (
    ...
    CONSTRAINT "PK_MftDistributionTypes" PRIMARY KEY ("Key")
);
...
CREATE TABLE "MftIndicators" (
    ...
    CONSTRAINT "PK_MftIndicators" PRIMARY KEY ("Id")
);
...
CREATE TABLE "MftDistributions" (
    ...
    "TypeKey" character varying(15) NOT NULL,
    ...
    CONSTRAINT "AK_MftDistributions_Year_TypeKey" UNIQUE ("Year", "TypeKey"),
    CONSTRAINT "FK_MftDistributions_MftDistributionTypes_TypeKey" FOREIGN KEY ("TypeKey") REFERENCES "MftDistributionTypes" ("Key") ON DELETE CASCADE
);
...
CREATE INDEX "IX_MftDistributions_TypeKey" ON "MftDistributions" ("TypeKey");
...
VALUES ('20220703054314_IntialSchema', '6.0.6');
