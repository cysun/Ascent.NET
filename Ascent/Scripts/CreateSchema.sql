...
CREATE TABLE "Courses" (
    ...
    "CourseJournalId" integer NULL,
    "IsObsolete" boolean NOT NULL,
    CONSTRAINT "PK_Courses" PRIMARY KEY ("Id"),
    CONSTRAINT "AK_Courses_Subject_Number" UNIQUE ("Subject", "Number"),
    CONSTRAINT "FK_Courses_CourseJournals_CourseJournalId" FOREIGN KEY ("CourseJournalId") REFERENCES "CourseJournals" ("Id")
);
...
CREATE TABLE "SampleStudents" (
    ...
    CONSTRAINT "PK_SampleStudents" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SampleStudents_CourseJournals_CourseJournalId" FOREIGN KEY ("CourseJournalId") REFERENCES "CourseJournals" ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_SampleStudents_CourseJournalId" ON "SampleStudents" ("CourseJournalId");
...
VALUES ('20230304012359_InitialSchema', '7.0.3');
